...
public class ServerApplication {
	...
	CommandLineRunner run(ServerRepo serverRepo){
		return args -> {
			...
			serverRepo.save(new Server(null, "192.168.1.14","Red Hat Enterprise Linux", "64Gb", "Mail Server", "http://localhost:8080/server/image/server4.png", Status.SERVER_DOWN));
